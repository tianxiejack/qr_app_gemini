...
#if 1
#if 1
	BrokenCam[0]=get_gpioNum_Value(GPIO_FAR_3_NUM);
	BrokenCam[1]=get_gpioNum_Value(GPIO_FAR_2_NUM);
	BrokenCam[2]=get_gpioNum_Value(GPIO_FAR_1_NUM);
	BrokenCam[3]=get_gpioNum_Value(GPIO_FAR_0_NUM);
