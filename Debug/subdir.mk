...
%.o: ../%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -DDISABLE_NEON_DEI=1 -DNO_ARM_NEON=1 -DMVDECT=1 -DWHOLE_PIC=1 -DUSE_BMPCAP=0 -DCAM_COUNT=8 -DTRACK_MODE=0 -DUSE_CAP_SPI=1 -DUSE_UART=0 -DDOUBLE_SCREEN=0 -DENABLE_ENHANCE_FUNCTION=1 -DTEST_GAIN=1 -DUSE_12=1 -DUSE_GAIN=1 -DGSTREAM_CAP=1 -I../OSA_CAP/inc -I/usr/include/GL -I../GLTool/include -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/aarch64-linux-gnu/glib-2.0/include -I/usr/lib/aarch64-linux-gnu/include -I/usr/include -I/usr/include/opencv -I/usr/lib/aarch64-linux-gnu/gstreamer-1.0/include -G -g -O0 -ccbin aarch64-linux-gnu-g++ -gencode arch=compute_50,code=sm_50 -m64 -odir "." -M -o "$(@:%.o=%.d)" "$<"

	/usr/local/cuda-8.0/bin/nvcc -DDISABLE_NEON_DEI=1 -DNO_ARM_NEON=1 -DMVDECT=1 -DWHOLE_PIC=1 -DDOUBLE_SCREEN=0 -DUSE_BMPCAP=0 -DCAM_COUNT=8 -DUSE_CAP_SPI=1 -DTRACK_MODE=0 -DUSE_UART=0 -DENABLE_ENHANCE_FUNCTION=1 -DTEST_GAIN=1 -DUSE_12=1 -DUSE_GAIN=1 -DGSTREAM_CAP=1 -I../OSA_CAP/inc -I/usr/include/GL -I../GLTool/include -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/aarch64-linux-gnu/glib-2.0/include -I/usr/lib/aarch64-linux-gnu/include -I/usr/include -I/usr/include/opencv -I/usr/lib/aarch64-linux-gnu/gstreamer-1.0/include -G -g -O0 --compile -m64 -ccbin aarch64-linux-gnu-g++  -x c++ -o  "$@" "$<"
